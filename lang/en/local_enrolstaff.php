...
$string['authorise:invalidtoken'] = 'The token is invalid or has expired.';
...
$string['field:registrycontact'] = 'Registry contact';
$string['field:registrycontact_help'] = 'The relevant registry contact for this user type.';
...
$string['notificationhelp'] = 'An email for authorisation or notification will be sent to users with the capability <strong>local/enrolstaff:authoriseenrolments</strong>.';
