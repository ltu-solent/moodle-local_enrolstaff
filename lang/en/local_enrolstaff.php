...
$string['enrol-requested-user'] = '{$a->firstname} {$a->lastname} has requested to be added to {$a->fullname} as {$a->rolename}.';
$string['enrol-requested-school'] = 'This is confirmation of your request to be added to {$a->fullname} as {$a->rolename}. The turnaround time for processing unit leader requests is 2-3 working days. If you do not have access to the unit after that time, please reply to this email in order to contact your School Executive Officer.';
