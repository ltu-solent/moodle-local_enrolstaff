...
if ($action == 'select_role') {
    ...
    echo $OUTPUT->single_button(new moodle_url('/local/enrolstaff/unenrolstaff.php'), get_string('unenrolfrommodules', 'local_enrolstaff'));
}
...
if ($action == 'confirm_select') {
    ...
    if (in_array($roleid, $unitleaderroleids)) {
        ...
        echo $OUTPUT->notification(get_string('enrolconfirmation', 'local_enrolstaff', ['shortname' => $c->shortname, 'rolename' => $rolename]), 'notifysuccess');
    }
